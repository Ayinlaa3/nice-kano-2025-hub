...
const schedule = {
  day1: [
    ...
    { time: "3:00 PM - 5:00 PM", title: "Construction Tech Innovation Challenge", venue: "Coronation Hall Exterior", tags: ["Innovation"], desc: "Technology innovation showcase and Pitching Contest." },
    { time: "6:00 PM", title: "Chairman's Cocktail & Engineering Business Roundtable", venue: "Tahir Guest Palace", tags: ["Networking"], desc: "Evening o networking and business discussions, connecting engineers and business owners to investors and business opportunities." },
  ],
  day2: [
